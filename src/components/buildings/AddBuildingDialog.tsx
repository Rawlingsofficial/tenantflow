// src/components/buildings/AddBuildingDialog.tsx
"use client";
...
export function AddBuildingDialog({
  ...
  // ONLY residential or commercial (no mixed)
          ...
          <div className="relative flex items-center gap-3">
            <div
              className={`flex items-center justify-center w-9 h-9 rounded-xl shadow-sm ${
                isCommercial ? "bg-[#1B3B6F]" : "bg-teal-600"
              }`}
            >
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Register a property in your portfolio
              </p>
            </div>
          </div>
            ...
            <div>
              <p
                className={`text-xs font-semibold ${
                  isCommercial ? "text-[#1B3B6F]" : "text-teal-700"
                }`}
              >
                {isCommercial
                  ? "Commercial Building"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <Input
                placeholder={
                  isCommercial
                    ? "e.g. Acme Business Centre"
                    : "e.g. Palm Grove Apartments"
                }
                value={form.name}
                onChange={(e) => updateField("name", e.target.value)}
                className="h-9 text-sm pl-9 rounded-xl border-slate-200"
                disabled={saving}
              />
            </div>
          </div>
