...
export default function MixedRevenueReport() {
  ...
  return (
    <div className="min-h-screen bg-[#070a0f]">
      <div className="px-6 pt-5 pb-4 flex items-center gap-3 border-b border-white/[0.05]">
        ...
        <h1 className="text-sm font-bold text-white">Revenue</h1>
      </div>
        ...
        <Tabs defaultValue="residential" className="w-full">
          <TabsList className="bg-white/[0.03] border border-white/[0.06] p-1 rounded-xl mb-5 w-fit">
            <TabsTrigger value="residential"
              className="text-[11px] font-semibold rounded-lg data-[state=active]:bg-teal-500/10 data-[state=active]:text-teal-300 text-gray-600 px-4 py-1.5 flex items-center gap-1.5">
              <Home className="h-3 w-3" /> Residential
            </TabsTrigger>
            <TabsTrigger value="commercial"
              className="text-[11px] font-semibold rounded-lg data-[state=active]:bg-indigo-500/10 data-[state=active]:text-indigo-300 text-gray-600 px-4 py-1.5 flex items-center gap-1.5">
